...
| `overseas` | 향후 `global_companies`에 추가할 해외 peer |
...
| 단계 | 코드 |
|---|---|
| 신뢰도 | `src/agents/credibility_agent.py` |
| 관련성 | `src/agents/relevance_agent.py` |
| 중복 제거/클러스터링 | `src/agents/dedup_agent.py` |
| 분류 | `src/agents/classification_agent.py` |
