...
# 작성자: 최종민
# 변경이력:
#   2026-04-22 최종민 — Track A/B 크롤러 v4 구축 및 PostgreSQL 저장 연동, 에이전트 버그 수정, Evidence Chain + Peer 4사 확장, 타입/포맷 정리
#   2026-04-30 박지원 — crawler v1부터 Track A/B/C·backfill·스케줄러·전처리·실시간 카드뉴스 파이프라인 구현 및 KST 날짜/품질 수정
#   2026-05-12 심유정 — 뉴스 연관성·클러스터링 플로우 개선 및 lint/mypy 정리
#   2026-06-12 안가은 — 대시보드 키워드 트렌드 파이프라인 업데이트
