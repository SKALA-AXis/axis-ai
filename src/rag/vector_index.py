...
# 작성자: 최종민
# 변경이력:
#   2026-04-28 최종민 — Qdrant Cloud 전환과 함께 vector_index 노드 도입, 이후 issue_cards→card_news 이름 변경 반영
#   2026-05-06 박지원 — 크롤러 구현·전처리 agent 수정에 맞춰 변경, 이후 수집 파이프라인의 신뢰도 점수 제거
