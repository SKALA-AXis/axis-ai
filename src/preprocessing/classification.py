...
# 작성자: 박지원
# 변경이력:
#   2026-05-19 박지원 — 분류 전처리 플로우 구축·리팩터, classifier LLM 지연 초기화, 뉴스 전처리 강화 및 LLM 폴백 제거
#   2026-06-11 최종민 — ChatOpenAI 지연 임포트로 import 체인 차단, gpt-4o 하드코딩 팩토리 이행, 단일 기사 텍스트 분류 엔드포인트 추가
