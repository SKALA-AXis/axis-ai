...
# 작성자: 박지원
# 변경이력:
#   2026-05-19 박지원 — Gate 2.5 관련성 판단 전처리 작성 및 peer/industry 관련성 규칙·클러스터링 정리 반복 보완
#   2026-06-08 최종민 — Gate 2.5 거부 규칙 완화(LLM 위임)·키워드 확장, ChatOpenAI 지연 임포트, gpt-4o 호출 팩토리 이행
