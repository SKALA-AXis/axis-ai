...
# 작성자: 최종민
# 변경이력:
#   2026-05-21 최종민 — Layer B 분석·카드뉴스 생성 파이프라인 베이스 러너 구축, card_news 백필을 point-in-time(시간순)으로 전환
#   2026-06-02 박지원 — 분석 러너 에이전트 재구성·이름 변경, 산업 트렌드 카드 요약 지원 및 카드 검증 완화
#   2026-06-05 심유정 — 전략 인사이트 근거화·카드 dry run 및 근거 기반 카드뉴스 생성 개선
