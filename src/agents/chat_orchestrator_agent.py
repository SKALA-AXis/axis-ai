...
# 작성자: 최종민
# 변경이력:
#   2026-05-15 최종민 — ChatOrchestrator 프로토타입(intent·routing·compose), Supervisor 패턴·출력 검증 헬퍼 추가, 이후 공용 스키마 contracts 이전·env-model 팩토리 이행 (#24-#26)
#   2026-05-19 박지원 — parser·agent 수정, 이후 카드뉴스 백필과 소스 카운트 추가
#   2026-06-08 박진 — 챗봇 에이전트·assistant RAG 추가, 포맷 정리, mixer chat·assistant 라우팅·PDF export 개선, 챗봇 분석 워크플로 개선 (#132)
