...
4. 그 다음 basis를 바탕으로 sentence/evidence_sentence를 작성합니다.
   ...
   특히 suggested_action.sentence는 SK AX가 이번 사건을 보고 가져갈 사업 방향만 남기고,
   ...
   제품명·서비스명·행사명은 현재 사건의 중심이면 사용할 수 있지만,
   그 이름을 "업무 범위·시스템 접점" 같은 내부 판단 축으로 바꿔 끼우거나
   명사 나열을 이어 붙여 대응방향 문장을 만들지 않습니다.
...
7. key_implication은 피어사 또는 시장 신호만 씁니다. SK AX 행동을 넣지 않습니다.
   ...
   뒷받침하는지만 설명합니다.
8. suggested_action은 SK AX가 다음 사업 판단과 준비에서 가져갈 방향을 씁니다.
   현재 사건이 보여준 실행 구조를 바탕으로 어떤 사업 관점, 운영 방식, 협력 전제를
   더 중요하게 봐야 하는지 말합니다.
   "제시해야 한다"로 외부 고객에게 낼 제안서를 쓰는 방식보다,
   SK AX가 앞으로 어떤 방향의 사업·운영 준비를 중시해야 하는지로 씁니다.
   여러 요소를 "나눠/구분해/분리해" 보라는 내부 체크리스트로 끝내지 말고,
   현재 사건이 드러낸 업무 변화나 시장 흐름을 어떤 사업 방향으로 연결할지 씁니다.
   ...
   대응방향은 SK AX가 어떤 데이터, 검증 환경, 파트너 역량을 사업 방향 안에서
   함께 고려해야 하는지로 씁니다. 단, 기사에 없는 약점이나 단점은 만들지 않습니다.
   ...
   먼저 실제로 기사에 나온 대상과 변화 지점을 찾고, 그 대상이 SK AX의 사업 방향에서
   어떤 준비 관점으로 이어지는지 낮은 강도로 작성합니다.
   ...
   현재 사건의 대상·고객군·도입 흐름이 SK AX의 사업 판단에 주는 관점을 씁니다.
   ...
   SK AX가 앞으로 더 중시할 업무 범위, 데이터 조건, 파트너 조건, 검증 환경 중
   무엇이 사업 방향의 핵심인지 정합니다.
   action_basis에는 대응 대상, 선택 근거, 사업 방향을 각각 명확히 적습니다.
   실행 관점은 입력 사건에 맞춰 필요한 축만 선택합니다.
   단순히 "점검한다/정리한다"에서 끝내지 말고, SK AX가 어떤 사업 방향으로 보거나
   어떤 운영 기준을 더 분명히 가져가야 하는지
...
16. 재무/거래구조 사건은 기술/사업역량으로 건너뛰지 말고, 거래 비중·매출 구성·비교군을
    ...
    suggested_action은 SK AX가 앞으로 사업 판단에서 봐야 할 지표, 고객군, 수익성,
...
- 대응방향은 현재 사건 anchor와 SK AX가 앞으로 가져갈 사업 방향, 준비 관점, 운영 전제를 함께 씁니다.
...
- 대응방향은 현재 사건 신호를 보고 SK AX가 앞으로의 사업 판단에서 무엇을
  더 명확히 봐야 하는지 씁니다. 기능, 시스템, 데이터, 검증, 파트너 같은 항목은
...
- frontend_ready 생성 가능성은 고객명/계약/구축 범위의 유무만으로 닫지 말고
  ...
  그 anchor가 보여주는 변화/차이와 SK AX의 대응 방향을 만들 수 있으면
...
- 재무·거래구조·지배구조 성격의 사건은 피어 프로필에서 같은 종류의
  ...
  입력에 함께 제공된 업계 기준, 규제/리스크 맥락, 시장 구조 fact가 있을 때만
  그 의미를 연결합니다. key_implication은 피어/시장 평가 기준의 변화를,
  suggested_action은 SK AX가 앞으로 어떤 성과 지표, 고객 설명 방식,
  사업화 조건을 더 중요하게 봐야 하는지 씁니다.
  현재 사건에 없는 기술·사업 성과, 원인, 대응 전략으로 건너뛰지 않습니다.
...
- frontend_ready.suggested_action.sentence는 1문장으로,
  SK AX가 앞으로의 사업 판단에서 무엇을 우선 봐야 하는지 씁니다.
  ...
  현재 기사에서 확인된 시장 변화나 고객 요구를 기준으로 SK AX가 다음 의사결정에서
  놓치지 말아야 할 관점을 신중하게 씁니다.
- frontend_ready.suggested_action.sentence는 key_implication.sentence의 핵심 명사 조합을
  그대로 반복하지 않습니다. key_implication은 피어/시장 의미,
  suggested_action은 SK AX가 다음에 참고할 사업 방향과 준비 관점을 씁니다.
...
- frontend_ready.suggested_action.evidence_sentence는 왜 그 대응이 필요한지 현재 사건 신호와
  ...
  피어사 기능·제품을 길게 나열하기보다, 대응방향을 이해하는 데 필요한 사실만 고릅니다.
  ...
  입력 fact에서 확인되는 실행 구조가 SK AX의 어떤 사업 방향이나 준비 관점으로 이어지는지
  설명합니다.
  대응방향 근거는 필요성을 선언하는 데서 멈추지 말고,
  현재 사건에서 드러난 변화, 범위, 단계, 구조 중 대응방향을 설명하는 데 필요한
  부분을 직접 설명합니다.
  문장의 끝은 필요성 선언을 반복하지 말고,
  현재 사건에서 확인된 제품·수치·적용 범위·운영 단계가 어떤 사업 방향을
  남기는지까지 풀어 씁니다.
...
- frontend_ready.suggested_action은 "경쟁력 강화", "차별화", "시장 공략" 같은
  목표 표현으로만 끝내지 말고, 현재 사건의 사실이 SK AX의 다음 판단에 주는
  실질적 의미까지 씁니다.
