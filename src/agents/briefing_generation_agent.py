...
# 작성자: 심유정
# 변경이력:
#   2026-05-27 심유정 — 브리핑 생성 에이전트 신설, 포맷·타입 검사 정리, 에이전트 아키텍처 파이프라인 반영 (#83)
#   2026-05-29 최종민 — 분석/브리핑 조회에서 DELETED 카드 제외, 이후 이벤트 루프 격리·read-through 재사용·모듈 분해·Langfuse 추적 누수 차단
#   2026-06-04 박진 — 통합 이슈 기반 mixer·executive 브리핑 플로우 추가·하드닝, 브리핑 생성 계약 상향, 포맷·타입 정리, 챗봇 분석 워크플로 개선 (#132)
