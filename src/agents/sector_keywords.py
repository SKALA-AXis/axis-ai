...
SECTOR_KEYWORDS: Final[dict[str, dict[str, list[str]]]] = {
    "security": {
        ...
        "keywords": [
            ...
            "AI 보안", "AI security", "secure AI", "프롬프트 인젝션",
        ],
    },
    "ai_tech": {
        "name_ko": "AI 기술동향",
        "keywords": [
            "에이전틱AI", "에이전틱 AI", "agentic AI", "AI 에이전트", "AI agent",
            "GPT", "LLM", "생성형 AI", "generative AI", "파운데이션", "foundation model",
            "팔란티어", "Palantir", "OpenAI", "Anthropic", "Claude", "Gemini",
            "RAG", "벡터", "임베딩", "AI 인프라", "AI Foundry", "GPU 클러스터",
            "LangChain", "MCP", "A2A",
        ],
    },
    "large_deal": {
        "name_ko": "대규모 수주",
        "keywords": [
            "수주", "대형 수주", "메가딜", "단일 수주", "프로젝트 수주",
            "공공", "공공 사업", "정부", "조달청", "디지털플랫폼정부",
            "국방", "국방부", "방산", "금융 차세대", "차세대 시스템",
            "스마트팩토리 구축", "ERP 구축", "MES 구축",
            "조 단위", "수천억", "수백억",
        ],
    },
    "sk_ax_biz": {
        "name_ko": "SK AX 사업영역",
        "keywords": [
            "제조AX", "제조 AX", "manufacturing AX",
            "에이전틱AI", "에이전틱 AI", "agentic AI",
            "MSP", "managed service provider", "클라우드 관리",
            "운영최적화", "운영 최적화", "프로세스 최적화",
            "AI 팩토리", "스마트팩토리", "smart factory",
            "디지털 트윈", "digital twin",
            "데이터 플랫폼",
        ],
    },
