...
# 작성자: 최종민
# 변경이력:
#   2026-04-22 최종민 — 크롤러·분석 파이프라인 및 DB(Supabase·Qdrant) 전환, card_news 리네임·global-trends·peer alignment 반영
#   2026-04-30 박지원 — 크롤러·전처리·DB 스키마 V31·article store 및 카드뉴스 생성·클러스터링·검증 파이프라인 개선
#   2026-05-12 심유정 — peer 뉴스 클러스터링·요약 및 카드뉴스 insight grounding·직렬화·frontend-ready 개선
