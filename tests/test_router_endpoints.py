...
# 작성자: 최종민
# 변경이력:
#   2026-06-12 최종민 — api/router 엔드포인트 happy-path 21종 회귀 테스트 작성(2-A5)
#   2026-06-15 박지원 — 카드뉴스 표시 데이터 sync에 맞춰 테스트 반영
#   2026-06-15 박진 — 유저 챗봇 api 라우트 노출 관련 테스트 추가
#   2026-06-16 심유정 — develop 브랜치 머지(today-insight 신호 없음 200 처리) 반영
