...
# 작성자: 최종민
# 변경이력:
#   2026-05-21 최종민 — Layer B 분석 파이프라인 도입과 함께 Supervisor 그래프 테스트 추가, 이후 백필 as_of(point-in-time) 배선
#   2026-05-26 박지원 — 분석 파이프라인 에이전트 재구성·뉴스 통합 흐름 및 실시간 카드 뉴스 파이프라인 정비
